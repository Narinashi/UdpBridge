...
namespace ConnectionBridge.NetCoreServer
{
    /// <summary>
    ...
    public class UdpClient : IDisposable
    {
        ...
        public virtual long Receive(ref EndPoint endpoint, byte[] buffer, long offset, long size)
        {
            ...
            try
            {
                ...
                OnReceived(endpoint, default, buffer, offset, size);
        ...
        /// </remarks>
        protected virtual void OnReceived(EndPoint endpoint, IPPacketInformation packetInfo, byte[] buffer, long offset, long size) { }
        /// <summary>
